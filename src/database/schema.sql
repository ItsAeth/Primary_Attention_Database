...
-- REGISTRO INFO CITAS, SANITARIOS, CITAS Y ACTIVIDAD LABORAL
...
CREATE TABLE IF NOT EXISTS pacientes (
    ...
    fax VARCHAR(30),
    cip_aut CHAR(16) UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS episodio(
	id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	tipo CHAR(1) NOT NULL CHECK (tipo IN ('S','E', 'U', 'P', 'A')),
	id_paciente BIGINT NOT NULL,
	id_sanitario BIGINT NOT NULL,
	...
	diag_snomed TEXT,
	observaciones TEXT,
	resultado CHAR(1) CHECK (resultado IN ('A', 'D', 'P')),
